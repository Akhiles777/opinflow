...
export default async function RespondentFeedPage({
  searchParams,
}: {
  ...
  const initialTab =
    params.tab === "inprogress" ? "inprogress" : params.tab === "completed" ? "completed" : "available";
  ...
  return (
    <div>
      <PageHeader
        title="Лента опросов"
        subtitle="Все доступные исследования, незавершённые прохождения и история."
      />
      <div className="mt-8">
        <SurveyFeedClient
